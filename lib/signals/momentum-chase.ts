...
// 阈值来源：REPORT-t7-actionable-labels.md 的动量基准分析——用全部价格快照（70万+个时点）按 24h涨幅
...
/**
 * 追涨风险信号：识别"过去24小时涨幅过大"的形态。REPORT-t7-actionable-labels.md 里最稳定的复现结论——
 * 不需要任何模型，"过去24h涨得最猛的饰品，未来7天大概率是要跌的"这个反向指标本身
 * 就有实操价值，跟"拉盘后急跌洗盘/出货"的业务认知吻合。这是提示性信号，不是确定性
 * 判断——大涨也可能是主拉升的开始（见 REPORT-manipulation-playbook-stages.md 急拉簇），需要用户自行判断。
 *
